...
const Homepage = ({ query }: { query: Record<string, unknown> }) => {
  ...
  return (
    <div className="space-y-7 max-w-5xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
            {ideas?.map((idea) => (
                <div key={idea.id} className="bg-white rounded-xl shadow-md overflow-hidden p-4 flex flex-col justify-between">
                    <Image
